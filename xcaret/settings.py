"""
Django settings for xcaret project.
...
WSGI_APPLICATION = "xcaret.wsgi.application"
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Loyalty Xcaret",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Loyalty Xcaret",
...
import json
try:
    JAZZMIN_UI_TWEAKS = json.loads(os.environ.get("JAZZMIN_UI_TWEAKS", "{}"))
